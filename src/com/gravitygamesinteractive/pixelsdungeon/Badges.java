...
import com.gravitygamesinteractive.pixelsdungeon.actors.mobs.Acidic;
import com.gravitygamesinteractive.pixelsdungeon.actors.mobs.Albino;
import com.gravitygamesinteractive.pixelsdungeon.actors.mobs.Bandit;
...
import com.gravitygamesinteractive.pixelsdungeon.items.rings.RingOfHaggler;
...
public class Badges {
	...
	public static enum Badge {
		...
		BOSS_SLAIN_1_ALL_CLASSES( "1st boss slain by all characters", 32, true ),
		...
		VICTORY_ALL_CLASSES( "Amulet of Yendor obtained by all characters", 36, true ),
	...
	public static void validateBossSlain() {
		...
		if (badge != null) {
			...
			if (badge == Badge.BOSS_SLAIN_1) {
				...
				case KYLE:
					badge = Badge.BOSS_SLAIN_1_KYLE;
					break;
				case IRIS:
					badge = Badge.BOSS_SLAIN_1_IRIS;
					break;
				case CHOMP:
					badge = Badge.BOSS_SLAIN_1_CHOMP;
					break;
				case WHOMP:
					badge = Badge.BOSS_SLAIN_1_WHOMP;
					break;
				case BLAZE:
					badge = Badge.BOSS_SLAIN_1_BLAZE;
					break;
				case ASH:
					badge = Badge.BOSS_SLAIN_1_ASH;
					break;
				case SHADE:
					badge = Badge.BOSS_SLAIN_1_SHADE;
					break;
				case BYTT:
					badge = Badge.BOSS_SLAIN_1_BYTT;
					break;
				}
				local.add( badge );
				...
				if (global.contains( Badge.BOSS_SLAIN_1_KYLE ) &&
					global.contains( Badge.BOSS_SLAIN_1_IRIS ) &&
					global.contains( Badge.BOSS_SLAIN_1_CHOMP ) &&
					global.contains( Badge.BOSS_SLAIN_1_WHOMP ) &&
					global.contains( Badge.BOSS_SLAIN_1_BLAZE ) &&
					global.contains( Badge.BOSS_SLAIN_1_ASH ) &&
					global.contains( Badge.BOSS_SLAIN_1_SHADE ) &&
					global.contains( Badge.BOSS_SLAIN_1_BYTT)) {
	...
	public static void validateMastery() {
		...
		switch (Dungeon.hero.heroClass) {
		case KYLE:
			badge = Badge.MASTERY_KYLE;
			break;
		case IRIS:
			badge = Badge.MASTERY_IRIS;
			break;
		case CHOMP:
			badge = Badge.MASTERY_CHOMP;
			break;
		case WHOMP:
			badge = Badge.MASTERY_WHOMP;
			break;
		case BLAZE:
			badge = Badge.MASTERY_BLAZE;
			break;
		case ASH:
			badge = Badge.MASTERY_ASH;
			break;
		case SHADE:
			badge = Badge.MASTERY_SHADE;
			break;
		case BYTT:
			badge = Badge.MASTERY_BYTT;
			break;
		}
	...
	public static void validateVictory() {
		...
		switch (Dungeon.hero.heroClass) {
		case KYLE:
			badge = Badge.VICTORY_KYLE;
			break;
		case IRIS:
			badge = Badge.VICTORY_IRIS;
			break;
		case CHOMP:
			badge = Badge.VICTORY_CHOMP;
			break;
		case WHOMP:
			badge = Badge.VICTORY_WHOMP;
			break;
		case BLAZE:
			badge = Badge.VICTORY_BLAZE;
			break;
		case ASH:
			badge = Badge.VICTORY_ASH;
			break;
		case SHADE:
			badge = Badge.VICTORY_SHADE;
			break;
		case BYTT:
			badge = Badge.VICTORY_BYTT;
			break;
		}
		local.add( badge );
		if (!global.contains( badge )) {
		...
		if (global.contains( Badge.VICTORY_KYLE ) &&
			global.contains( Badge.VICTORY_IRIS ) &&
			global.contains( Badge.VICTORY_CHOMP ) &&
			global.contains( Badge.VICTORY_WHOMP ) &&
			global.contains( Badge.VICTORY_BLAZE ) &&
			global.contains( Badge.VICTORY_ASH ) &&
			global.contains( Badge.VICTORY_SHADE ) &&
			global.contains( Badge.VICTORY_BYTT )) {
