...
import com.gravitygamesinteractive.pixelsdungeon.DungeonTilemap;
import com.gravitygamesinteractive.pixelsdungeon.FogOfWar;
...
import com.gravitygamesinteractive.pixelsdungeon.effects.BlobEmitter;
import com.gravitygamesinteractive.pixelsdungeon.effects.EmoIcon;
import com.gravitygamesinteractive.pixelsdungeon.effects.Flare;
import com.gravitygamesinteractive.pixelsdungeon.effects.FloatingText;
import com.gravitygamesinteractive.pixelsdungeon.effects.Ripple;
import com.gravitygamesinteractive.pixelsdungeon.effects.SpellSprite;
...
import com.gravitygamesinteractive.pixelsdungeon.levels.RegularLevel;
import com.gravitygamesinteractive.pixelsdungeon.levels.features.Chasm;
import com.gravitygamesinteractive.pixelsdungeon.plants.Plant;
import com.gravitygamesinteractive.pixelsdungeon.sprites.CharSprite;
import com.gravitygamesinteractive.pixelsdungeon.sprites.DiscardedItemSprite;
...
import com.gravitygamesinteractive.pixelsdungeon.sprites.PlantSprite;
import com.gravitygamesinteractive.pixelsdungeon.ui.AttackIndicator;
import com.gravitygamesinteractive.pixelsdungeon.ui.Banner;
import com.gravitygamesinteractive.pixelsdungeon.ui.BusyIndicator;
import com.gravitygamesinteractive.pixelsdungeon.ui.GameLog;
import com.gravitygamesinteractive.pixelsdungeon.ui.HealthIndicator;
import com.gravitygamesinteractive.pixelsdungeon.ui.QuickSlot;
import com.gravitygamesinteractive.pixelsdungeon.ui.StatusPane;
import com.gravitygamesinteractive.pixelsdungeon.ui.Toast;
import com.gravitygamesinteractive.pixelsdungeon.ui.Toolbar;
...
import com.gravitygamesinteractive.pixelsdungeon.windows.WndStory;
import com.gravitygamesinteractive.pixelsdungeon.windows.WndBag.Mode;
...
public class GameScene extends PixelScene {
	...
	public void create() {
		...
		try {
			...
			moduleFile = Game.instance.getAssets().open(Assets.MUSIC1TOWER);
			//moduleFile = App.getContext().getAssets().open("tower1.it");
			//moduleFile = PixelDungeon.getAssets().open(Assets.MUSIC1TOWER);
			//moduleFile = new InputStream(Resources.getSystem().getString(R.raw.));
			//ArrayList<Byte> moduleDataArray = new ArrayList<Byte>();
		...
		if(moduleData != null){
			...
			if(App.getMusicPlayer() != null){
				//PlayerThread pt = App.getMusicPlayer();
				//pt = new PlayerThread(moduleData, 0);
				//App.pauseModMusic();
				App.switchModMusic(moduleData);
				//App.startModMusic();
				App.setVolume(255);
