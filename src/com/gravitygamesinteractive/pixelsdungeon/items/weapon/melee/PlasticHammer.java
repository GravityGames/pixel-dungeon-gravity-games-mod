...
public class PlasticHammer extends MeleeWeapon {
	...
	public String desc() {
		return 
			"This hammer looks just like Kyle's! It's actually pretty durable for, you know, a plastic hammer...";
	}
	...
	private final WndBag.Listener itemSelector = new WndBag.Listener() {
		...
		public void onSelect( Item item ) {
			if (item != null && !(item instanceof Boomerang)) {
				...
				if (equipped) {
					curUser.belongings.weapon = PlasticHammer.this;
				} else {
