...
import com.gravitygamesinteractive.pixelsdungeon.items.rings.RingOfPower.Power;
...
public abstract class Wand extends KindOfWeapon {
	...
	public String info() {
		...
		if (Dungeon.hero.heroClass == HeroClass.IRIS) {
			info.append( "\n\n" );
			if (levelKnown) {
	...
	protected class Charger extends Buff {
		...
		protected void delay() {
			float time2charge = ((Hero)target).heroClass == HeroClass.IRIS ? 
