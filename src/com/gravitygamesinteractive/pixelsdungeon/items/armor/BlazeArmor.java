...
public class BlazeArmor extends ClassArmor {
	
	private static final String TXT_NO_ENEMIES 		= "No enemies in sight";
	private static final String TXT_NOT_BLAZE	= "Only huntresses can use this armor!";
	
	private static final String AC_SPECIAL = "SPECTRAL BLADES"; 
	
	{
		name = "huntress cloak";
		image = ItemSpriteSheet.ARMOR_BLAZE;
	}
	...
	public boolean doEquip( Hero hero ) {
		if (hero.heroClass == HeroClass.BLAZE) {
			return super.doEquip( hero );
		} else {
			GLog.w( TXT_NOT_BLAZE );
			return false;
		}
	}
