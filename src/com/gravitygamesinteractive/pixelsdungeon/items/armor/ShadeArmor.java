...
import com.gravitygamesinteractive.pixelsdungeon.items.weapon.missiles.Shuriken;
...
import com.gravitygamesinteractive.pixelsdungeon.sprites.MissileSprite;
import com.gravitygamesinteractive.pixelsdungeon.utils.GLog;
import com.watabou.utils.Callback;

public class ShadeArmor extends ClassArmor {
	
	private static final String TXT_NO_ENEMIES 		= "No enemies in sight";
	private static final String TXT_NOT_SHADE	= "Only huntresses can use this armor!";
	
	private static final String AC_SPECIAL = "SPECTRAL BLADES"; 
	
	{
		name = "shade cloak";
		image = ItemSpriteSheet.ARMOR_SHADE;
	}
	...
	public boolean doEquip( Hero hero ) {
		if (hero.heroClass == HeroClass.SHADE) {
			return super.doEquip( hero );
		} else {
			GLog.w( TXT_NOT_SHADE );
			return false;
		}
	}
