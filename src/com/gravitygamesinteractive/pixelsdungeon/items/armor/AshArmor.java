...
public class AshArmor extends ClassArmor {
	
	private static final String TXT_NO_ENEMIES 		= "No enemies in sight";
	private static final String TXT_NOT_ASH	= "Only huntresses can use this armor!";
	
	private static final String AC_SPECIAL = "SPECTRAL BLADES"; 
	
	{
		name = "ash cloak";
		image = ItemSpriteSheet.ARMOR_ASH;
	}
	...
	public boolean doEquip( Hero hero ) {
		if (hero.heroClass == HeroClass.ASH) {
