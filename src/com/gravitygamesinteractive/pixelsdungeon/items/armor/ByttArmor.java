...
public class ByttArmor extends ClassArmor {
	
	private static final String TXT_NO_ENEMIES 		= "No enemies in sight";
	private static final String TXT_NOT_BYTT	= "Only Bytt can use this armor!";
	
	private static final String AC_SPECIAL = "SPECTRAL BLADES"; 
	
	{
		name = "bytt cloak";
		image = ItemSpriteSheet.ARMOR_BYTT;
	}
	...
	public boolean doEquip( Hero hero ) {
		if (hero.heroClass == HeroClass.BYTT) {
