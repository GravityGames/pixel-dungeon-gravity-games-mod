...
public class WhompArmor extends ClassArmor {
	
	private static final String TXT_NO_ENEMIES 		= "No enemies in sight";
	private static final String TXT_NOT_WHOMP	= "Only huntresses can use this armor!";
	
	private static final String AC_SPECIAL = "SPECTRAL BLADES"; 
	
	{
		name = "huntress cloak";
		image = ItemSpriteSheet.ARMOR_WHOMP;
	}
	...
	public boolean doEquip( Hero hero ) {
		if (hero.heroClass == HeroClass.WHOMP) {
			return super.doEquip( hero );
		} else {
			GLog.w( TXT_NOT_WHOMP );
			return false;
		}
	}
